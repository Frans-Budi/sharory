...
class EmailEditText @JvmOverloads constructor(
    context: Context, attribute: AttributeSet? = null,
) : TextInputEditText(context, attribute), View.OnTouchListener {
    ...
    init {
        ...
        iconStart = ContextCompat.getDrawable(context, R.drawable.custom_email_icon) as Drawable
